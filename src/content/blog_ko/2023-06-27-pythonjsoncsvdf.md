---
title: "Python으로 네스트된 JSON(딕셔너리 타입)을 CSV나 df로 변환하는 방법"
...
<p><a href="https://draft.blogger.com/blog/post/edit/3231669075263956300/1170695230331030502?hl=ja#">날씨 웹 서비스의 API</a>에서 JSON을 가져와서, 중첩된 JSON의 값을 재귀 함수를 사용하여 완전히 가져와서 Excel, CSV, Pandas의 데이터 프레임 등으로 변환하는 코드를 작성했습니다. 간단히 설명하겠습니다.<br></p><h2 id="hcf2b66e679">코드</h2><pre><code class="hljs"><span class="hljs-keyword">import</span> time
